        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <Card className="shadow-lg bg-gray-900/60 backdrop-blur-sm border-primary/20">
                <CardContent className="p-6">
                    ...
                    <div className="h-80 overflow-y-auto space-y-6 scrollbar-gutter-stable pr-2">
                        ...
                        <div key={index} className={cn('flex items-start gap-4', message.role === 'user' ? 'justify-end' : 'justify-start')}>
                            ...
                            <div className={cn('max-w-[85%] rounded-lg p-3 text-sm', message.role === 'user' ? 'bg-primary text-primary-foreground' : 'bg-gray-800 text-gray-200')}>
                            <p>{message.content}</p>
                            </div>
                            {message.role === 'user' && (
